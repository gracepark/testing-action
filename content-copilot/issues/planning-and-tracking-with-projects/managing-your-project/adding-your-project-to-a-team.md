...
**Who can use this feature**: Organization owners or people with the team maintainer role and admin permissions on a project can add a project to a team.
...
1. In the search field, start typing the name of the project you want to add and then select the project in the list of matches.
   ...
   **Note:** If this change will result in increased project permissions for the team's members, GitHub will prompt you to confirm your choice.
