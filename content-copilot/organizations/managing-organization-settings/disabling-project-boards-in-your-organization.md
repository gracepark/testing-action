...
## Disabling classic projects in your organization
...
1. Decide whether to disable classic projects in your organization. Then, under **Projects**:
    - To disable classic projects, unselect **Enable Projects for the organization**.
    - To enable classic projects in the organization, select **Enable Projects for the organization**.
1. Click **Save**.

If you decide to re-enable classic projects, any classic projects that were previously added will be available.
