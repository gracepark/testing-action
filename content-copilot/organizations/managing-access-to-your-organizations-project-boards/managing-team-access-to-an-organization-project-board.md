...
- If you add or remove classic project access for a parent team, each of that parent's child teams will also receive or lose access to the classic project. For more information, see "[AUTOTITLE](/organizations/organizing-members-into-teams/about-teams)."
...
1. To change permissions levels, to the right of the classic project you want to update, use the permission level dropdown menu.
