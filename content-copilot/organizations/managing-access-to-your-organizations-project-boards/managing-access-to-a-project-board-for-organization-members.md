...
**Tip:** You can give an organization member higher permissions to classic project. For more information, see "[AUTOTITLE](/organizations/managing-access-to-your-organizations-project-boards/project-board-permissions-for-an-organization)."
...
1. In the projects list, click the name of the classic project.
