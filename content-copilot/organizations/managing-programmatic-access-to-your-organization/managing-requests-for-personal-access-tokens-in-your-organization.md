...
**Note**: Only fine-grained personal access tokens, not personal access tokens, are subject to approval. Unless the organization has restricted access by personal access tokens, any personal access token can access organization resources without prior approval. For more information, see "[AUTOTITLE](/organizations/managing-programmatic-access-to-your-organization/setting-a-personal-access-token-policy-for-your-organization)."
