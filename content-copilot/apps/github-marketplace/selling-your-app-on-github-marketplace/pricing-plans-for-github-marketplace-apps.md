...
Customers purchase your app using a payment method attached to their account on GitHub.com, without having to leave GitHub.com. You don't have to write code to perform billing transactions, but you will have to handle events from the GitHub Marketplace API. For more information, see "[AUTOTITLE](/apps/github-marketplace/using-the-github-marketplace-api-in-your-app)."
