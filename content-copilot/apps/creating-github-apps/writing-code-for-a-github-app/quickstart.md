...
GitHub Apps let you automate processes or integrate other platforms with GitHub. For more info, see "[AUTOTITLE](/apps/creating-github-apps/creating-github-apps/about-apps)."
...
1. Clone the [github/github-app-js-sample](https://github.com/github/github-app-js-sample) repository. For more information, see "[AUTOTITLE](/repositories/creating-and-managing-repositories/cloning-a-repository)." You may use a local clone or GitHub Codespaces.
