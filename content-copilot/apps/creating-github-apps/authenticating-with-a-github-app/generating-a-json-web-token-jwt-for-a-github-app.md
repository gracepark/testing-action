...
|`iss`| Issuer | The ID of your GitHub App. This value is used to find the right public key to verify the signature of the JWT. You can find your app's ID with the `GET /app` REST API endpoint. For more information, see "[Apps](/rest/apps/apps)" in the REST API documentation.|
