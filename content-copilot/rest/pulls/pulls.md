...
If a diff is corrupt, contact us through the [GitHub Support portal](https://support.github.com). Include the repository name and pull request ID in your message.
