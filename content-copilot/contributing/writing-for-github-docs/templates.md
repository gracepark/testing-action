...
Use the content model for full instructions and examples on how to write for GitHub Docs. For more information, see "[AUTOTITLE](/contributing/style-guide-and-content-model/about-the-content-model)."
