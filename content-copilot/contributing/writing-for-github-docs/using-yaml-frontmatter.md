...
**Note:** The `effectiveDate` frontmatter value is for use by GitHub staff only.
...
To create a product guides page (e.g. [GitHub Actions Guide page](/actions/guides)), create or modify an existing markdown file with these specific frontmatter values:
