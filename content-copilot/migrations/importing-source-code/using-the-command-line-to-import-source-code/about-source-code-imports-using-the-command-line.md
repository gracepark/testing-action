...
- To import a Git repository that is stored on a code hosting service that is not accessible from the public internet, see "[AUTOTITLE](/migrations/importing-source-code/using-the-command-line-to-import-source-code/importing-an-external-git-repository-using-the-command-line)."
