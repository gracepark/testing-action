...
**Who can use this feature**: People with admin permissions to a repository can enable GitHub Discussions for the repository.
...
**Settings**.
   ...
   ![Screenshot of the tabs in a GitHub repository. The "Settings" option is outlined in dark orange.](/assets/images/help/discussions/public-repo-settings.png)
